...
$(function(){
	$('#user-table thead tr:first').addClass("danger")
	$('#user-table th').addClass("text-center")
	
	let html='';
	music.map((m)=>{
		html+='<tr>'
			+'<td class="text-center">'+m.no+'</td>'
			+'<td class="text-center"><img src="'+m.poster+'" width=30></td>'
			+'<td>'+m.title+'</td>'
			+'<td>'+m.singer+'</td>'
			+'<td>'+m.album+'</td>'
			+'</tr>'
...
<body>
	<div class="container">
		<h1 class="text-center">Music Top50</h1>
		<div class="row">
			<table class="table">
			  <tr>
			  	<td>
