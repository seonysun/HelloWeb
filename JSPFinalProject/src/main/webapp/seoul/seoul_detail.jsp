...
<div class="wrapper row3">
  <main class="container clear">
  	...
  	<table class=table>
  	  <tr>
  	  	<td><img src="${vo.poster }" style="width: 100%"></td>
  	  </tr>
  	  <tr>
  	  	<td>${vo.msg }</td>
  	  </tr>
...
<!-- 카카오맵 api https://apis.map.kakao.com/web/sample/keywordList/ -->
<div class="map_wrap">
...
function removeAllChildNods(el) {   
    ...
    <h2 class="sectiontitle">인근 맛집 목록</h2>
    <div class="flexslider carousel basiccarousel btmspace-80">
      <ul class="slides">
        <c:forEach var="fvo" items="${list }" varStatus="s">
	        <li>
	         <a href="../food/food_detail.do?fno=${fvo.fno }">
	          <figure><img class="radius-10 btmspace-10" src="${fvo.poster }" title="${fvo.type }" style="height: 280px">
	            <figcaption>${fvo.name }</figcaption>
	          </figure>
	         </a>
	        </li>
       </c:forEach>
	  		  	  	  	...
	  		  	  	  	<td class="text-right" width=15%>
	  		  	  	  		<c:if test="${sessionScope.id!=null }">
	  		  	  	  			<c:if test="${sessionScope.id==rvo.id }">
	  		  	  	  				...
	  		  	  	  				<a href="../all_reply/all_reply_delete.do?rno=${rvo.rno }&no=${vo.no }&cate_no=1" class="btn btn-xs btn-danger">삭제</a>
	  		  	  	  			</c:if>
	  		  	  	  		</c:if>
	  		  	  	  	</td>
	  		  	  	  </tr>
