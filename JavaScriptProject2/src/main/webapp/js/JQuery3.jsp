...
function movie(no){
	for(let m of music){
		if(m.no==no){
			$('#title').text(m.title) //태그 사이에 값 채우기
			$('#movie').attr("src","http://youtube.com/embed/"+m.key) //속성에 값 채우기
			break;
		}
	}
}
...
<body>
	<div class="container">
		<div class="row">
			<h1 class="text-center">지니뮤직 Top50</h1>
			<div class="col-sm-9">
				<table class="table table-hover">
				  <thead>
					  <tr>
					  	<th class="text-center" colspan=2>순위</th>
			...
			<div class="col-sm-3">
				<h3 id=title></h3>
				<embed id=movie src="" width=300 height=250></embed>
			</div>
		</div>
	</div>
</body>
