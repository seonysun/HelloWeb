...
public class GoodsVO {
	private int gno,cno,goods_price,goods_percent,first_buy_price,account,jjim_count,like_count,hit;
	private String goods_name,goods_poster,goods_content,send;
	public int getGno() {
		return gno;
	}
	...
	public int getFirst_buy_price() {
		return first_buy_price;
	}
	public void setFirst_buy_price(int first_buy_price) {
		this.first_buy_price = first_buy_price;
	}
